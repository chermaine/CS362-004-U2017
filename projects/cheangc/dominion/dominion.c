...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card ) {
        case adventurer:  return adventurerEffect(currentPlayer, state, handPos);
            
        case council_room:  return councilRoomEffect(currentPlayer, state, handPos);
        ...
        case mine:  return mineEffect(currentPlayer, state, choice1, choice2, handPos);
        ...
        case smithy:  return smithyEffect(currentPlayer, state, handPos);
            
        case village: return villageEffect(currentPlayer, state, handPos);
