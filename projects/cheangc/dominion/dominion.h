...
int smithyEffect(int player, struct gameState *state, int smithyIndex);
int adventurerEffect(int player, struct gameState *state, int adventurerIndex);
int councilRoomEffect(int player, struct gameState *state, int coucilRoomIndex);
int villageEffect(int player, struct gameState *state, int villageIndex);
int mineEffect(int player, struct gameState *state, int choice1, int choice2, int mineIndex);
